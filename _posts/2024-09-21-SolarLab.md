...
<img src="/images/box-images/SolarLab/SolarLab_SMB_RIDBrute.png">
...
<img src="/images/box-images/SolarLab/SolarLab_Hydra_Users.png">
...
<img src="/images/box-images/SolarLab/SolarLab_Hydra_BlakeB.png">

## Reports Login:
* Now we have a valid login lets login to the webpage at `report.solarlab.htb:6791`.
* We manage to login with `BlakeB` `ThisCanB3typedeasily1@`

<img src="/images/box-images/SolarLab/SolarLab_Report_Login.png">

* Each of these options on this page seems to generate a `pdf` file.

<img src="/images/box-images/SolarLab/SolarLab_Report_PDF_Example.png">
