...
<a href="https://github.com/GitMirar/hMailDatabasePasswordDecrypter">hMailServer Pass Cracker</a>

<i class="fa-solid fa-frog" style="color: #b8bb26;"> Decrypting the password with this tool gives us `6FC6F69152AD`. Though Im not sure what to do with it at this moment.
...
* Going back to the website we can see a `download instrcutions` button at the bottom of the screen. It leads to a PDF you can download with instructions on home to connect to the mail server.
