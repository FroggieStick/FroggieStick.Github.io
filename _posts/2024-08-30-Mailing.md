...
* Appears to be a md5 hash for a `AdministratorPassword`
    ...
    <i class="fa-solid fa-key-2xl" style="color: #fabd27;"></i> `841bb5acfa6779ae432fd7a4e6600ba7`
...
* We successfully crack the hash with the password of:
    ...
    <i class="fa-solid fa-key fa-2xl" style="color: #fabd27;"></i> `homenetworkingadministrator`
